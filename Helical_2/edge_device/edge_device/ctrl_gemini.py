...
class systemDevice:
    ...
    def __init__(self, devicetype: deviceType, commtype: commType, cfg: Dict[str, Any], rated_power=125000) -> None:
...
def getAggDGlim():
    ...
    for device in device_list:
        if device.device_type == deviceType.meter and device.connected_to == str(deviceType.DG.value):
            total_power_dm = device.measured_data.total_power
            if total_power_dm is not None and total_power_dm.model_present and total_power_dm.value > 0:
