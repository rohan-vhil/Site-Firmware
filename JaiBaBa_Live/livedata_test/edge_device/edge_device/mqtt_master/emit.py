...
async def main():
    ...
    async with connection:
        ...
        # }
        # live_data_message = aio`_pika.Message(
        ...
        #    }
        #}
        control_payload = "START_LIVE_DATA"
        # control_payload = {
        #     "mode": "export_limit",
        #     "op_details": {
        #         "bat_to_load": True,
        ...
        #    delivery_mode=aio_pika.DeliveryMode.PERSISTENT
        #)
        control_payload = b"START_LIVE_DATA"
        control_message = aio_pika.Message(
            body=control_payload,
            delivery_mode=aio_pika.DeliveryMode.PERSISTENT
        )
        routing_key_control = f"command.asawa"
