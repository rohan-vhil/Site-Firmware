...
PUBLISH_ROUTING_KEY = 'live_data.jaibaba'
LISTEN_QUEUE = 'command.jaibaba'
LISTEN_ROUTING_KEY = 'command.jaibaba' 
...
# --- New Device IDs ---
LT_PANEL_ID = 'LT:Secure:5842864'
HT_PANEL_ID = 'HT:EM6400NG:3412843'
...
def livdataHandler(data):
        ...
        for device in data:
            ...
            message[device] = data[device]["total_power"]
...
def publish_message(message):
    try:
        ...
        channel.exchange_declare(exchange=EXCHANGE_NAME, exchange_type='topic', durable=True)
                # Declare queues
        channel.queue_declare(queue=PUBLISH_ROUTING_KEY, durable=True)
