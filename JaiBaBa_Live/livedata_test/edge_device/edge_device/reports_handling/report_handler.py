...
class dataBank:
    ...
    def runDataLoop(self):
        while( not os.path.exists(path_config.path_cfg.base_path + "../submodules/RpiBackend/app/json_files/installer_cfg.json")):
            #print("no file")
            pass
        while(os.path.exists(path_config.path_cfg.base_path + "../submodules/RpiBackend/app/json_files/installer_cfg.json")):
            self.data_queue
