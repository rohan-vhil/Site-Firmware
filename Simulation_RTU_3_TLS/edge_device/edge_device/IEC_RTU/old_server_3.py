...
#
# --- !! IMPORTANT FIX 1: CORRECTED SERVER LOGIC !! ---
# This function now correctly reads the firmware_device_id
#
def startIECServer():
    global server
    server = c104.Server()
...
#
# --- !! IMPORTANT FIX 2: DEBUG PRINT STATEMENT ADDED !! ---
# This function now prints the data it receives
#
def runServer(val):
    global vals
    while(1):
        ...
        print("\n--- [IEC Server] Received data from firmware ---")
        print(vals)
        print("----------------------------------------------\n")
        
        time.sleep(5) # Keep this loop relaxed, as it only needs to update the global `vals`
