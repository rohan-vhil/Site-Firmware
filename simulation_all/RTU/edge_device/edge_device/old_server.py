    ...
    def dataReader(point : c104.Point)->None:
            try:
                ...
                print(point.value)
                 ...
                 print(e)
            print(f"----ReaderFunc device_id : {device_id} param_name : {param_name} point_addr : {point.io_address} point_value : {point.value}")
...
def main():
    ...
    device_id="solar-inverter:GROWATT123:123abc"
    name = "total_power"
